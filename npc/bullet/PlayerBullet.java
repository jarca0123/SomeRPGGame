...
public class PlayerBullet extends Bullet {
    ...
    public int msOfDamageResistance = 2000;
    ...
    public void draw(Graphics2D g2d) {
        super.draw(g2d);
        g2d.drawImage(Game.sprites.get(12), Game.world.battle.gui.battleInteraction.x + x, Game.world.battle.gui.battleInteraction.y + y, 20, 20, null);
    }
}
